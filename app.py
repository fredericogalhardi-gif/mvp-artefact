...
INITIAL_LEADS = [
    ...
    {'Cargo': 'Líder de Produto de Dados e IA', 'Descricao': '', 'Empresa': 'Grupo Boticário', 'ID': 214, 'LinkedIn': '', 'Nome': 'Thiago Neubauer', 'Podcast': False, 'Prioritario': False, 'Status': 'whatsapp não Tema': ''},
